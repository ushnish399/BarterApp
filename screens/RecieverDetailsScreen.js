...
export default class RecieverDetailsScreen extends Component{
  ...
  addNotification=()=>{
    var message = this.state.userName + " has shown interest in donating the object"
        ...
        <View style={styles.container}>
          <View style={{flex:0.1}}>
            <Header
              ...
              centerComponent={{ text:"Donate Objects", style: { color: '#90A5A9', fontSize:20,fontWeight:"bold", } }}
